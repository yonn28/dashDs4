...
'''
5. Función hacer un grafico de shap values solo para el decil del 10% (me parece este mejor):
'''
...
# plotShapValuesTop(modelo_relapse,base_relapse)
# plotShapValuesTop(modelo_malnutrition,base_malnutrition)